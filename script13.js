...
function runTheExample(){
	...
	if (myElement != null){
		alert(myElement.innerHTML);	// caution with innerHTML not fully supported
	}
	
	document.getElementById('second').innerHTML = "<em>See how I set the text here?</em>";
	...
	myElement.childNodes[i]; // myElement.childNodes.length
	...
	// older browsers may need the following:
	//anchor.setAttribute('href', 'http://learnvisualstudio.net');
